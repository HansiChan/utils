...
class LLSpider(object):
    ...
    def __init__(self):
        ...
        cnxnstr = "Driver={/opt/cloudera/impalaodbc/lib/64/libclouderaimpalaodbc64.so};HOST=192.168.3.191;PORT=21050;UID=hive;AuthMech=3;PWD=hive;UseSasl=0"
    ...
    def get_data(self):
        ...
        dateList = self.get_dateList(str(datetime.date.today()))
        for dt in dateList:
